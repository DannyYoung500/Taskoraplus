...
export function BottomNav() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-40 border-t border-cyan-400/10 bg-[#030814]/95 backdrop-blur-xl">
          ...
          return (
            <li key={to} className="flex-1">
              ...
              >
                ...
                {active ? (
                  <span className="mt-0.5 h-0.5 w-5 rounded-full bg-cyan-400" />
                ) : (
