...
// TASKORA routes — /owner without trailing slash (fixes 404)
...
const AuthenticatedOwnerWelcomeRoute = AuthenticatedOwnerWelcomeRouteImport.update({ id: '/owner/welcome', path: '/owner/welcome', getParentRoute: () => AuthenticatedRouteRoute } as any)
const AuthenticatedOwnerCampaignsRoute = AuthenticatedOwnerCampaignsRouteImport.update({ id: '/owner/campaigns', path: '/owner/campaigns', getParentRoute: () => AuthenticatedRouteRoute } as any)
const AuthenticatedOwnerLedgerRoute = AuthenticatedOwnerLedgerRouteImport.update({ id: '/owner/ledger', path: '/owner/ledger', getParentRoute: () => AuthenticatedRouteRoute } as any)
const AuthenticatedOwnerDepositsRoute = AuthenticatedOwnerDepositsRouteImport.update({ id: '/owner/deposits', path: '/owner/deposits', getParentRoute: () => AuthenticatedRouteRoute } as any)
const AuthenticatedOwnerConnectedRoute = AuthenticatedOwnerConnectedRouteImport.update({ id: '/owner/connected', path: '/owner/connected', getParentRoute: () => AuthenticatedRouteRoute } as any)
const AuthenticatedOwnerRolesRoute = AuthenticatedOwnerRolesRouteImport.update({ id: '/owner/roles', path: '/owner/roles', getParentRoute: () => AuthenticatedRouteRoute } as any)
const AuthenticatedOwnerEconomyRoute = AuthenticatedOwnerEconomyRouteImport.update({ id: '/owner/economy', path: '/owner/economy', getParentRoute: () => AuthenticatedRouteRoute } as any)
const AuthenticatedOwnerFlagsRoute = AuthenticatedOwnerFlagsRouteImport.update({ id: '/owner/flags', path: '/owner/flags', getParentRoute: () => AuthenticatedRouteRoute } as any)
const AuthenticatedOwnerAuditRoute = AuthenticatedOwnerAuditRouteImport.update({ id: '/owner/audit', path: '/owner/audit', getParentRoute: () => AuthenticatedRouteRoute } as any)
const AuthenticatedOwnerHealthRoute = AuthenticatedOwnerHealthRouteImport.update({ id: '/owner/health', path: '/owner/health', getParentRoute: () => AuthenticatedRouteRoute } as any)
const AuthenticatedOwnerDocumentsRoute = AuthenticatedOwnerDocumentsRouteImport.update({ id: '/owner/documents', path: '/owner/documents', getParentRoute: () => AuthenticatedRouteRoute } as any)
const AuthenticatedOwnerMonetizationRoute = AuthenticatedOwnerMonetizationRouteImport.update({ id: '/owner/monetization', path: '/owner/monetization', getParentRoute: () => AuthenticatedRouteRoute } as any)
const AuthenticatedOwnerVideosRoute = AuthenticatedOwnerVideosRouteImport.update({ id: '/owner/videos', path: '/owner/videos', getParentRoute: () => AuthenticatedRouteRoute } as any)
const AuthenticatedOwnerPaymentSettingsRoute = AuthenticatedOwnerPaymentSettingsRouteImport.update({ id: '/owner/payment-settings', path: '/owner/payment-settings', getParentRoute: () => AuthenticatedRouteRoute } as any)
