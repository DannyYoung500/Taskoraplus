...
export const SERVICES: Record<Platform, ServiceDef[]> = {
  instagram: [
    ...
    S("ig_comments", "comment", "Instagram Comments", "Real comments on your Instagram post", 0.025, 0.0175, 0.0075, "comments", 20, 5000, [20, 50, 100, 250], "~48h", "https://www.instagram.com/p/…", ["Comment on this Instagram post"], ["Open the post", "Write a relevant comment", "Screenshot", "Submit proof"], "Spam or emoji-only comments may be rejected."),
    S("ig_views", "view", "Instagram Video Views", "Real views on your Instagram reel or video", 0.0025, 0.00175, 0.00075, "views", 500, 100000, [500, 1000, 5000, 10000], "~24h", "https://www.instagram.com/reel/…", ["Watch this Instagram reel"], ["Open the reel", "Watch at least 5 seconds", "Screenshot", "Submit proof"], "Watch the required duration before submitting."),
  ],
  youtube: [
    S("yt_subs", "subscribe", "YouTube Subscribers", "Real subscribers on your YouTube channel", 0.03, 0.021, 0.009, "subscribers", 100, 10000, [100, 250, 500, 1000], "~72h", "https://www.youtube.com/@yourchannel", ["Subscribe to this YouTube channel"], ["Open the channel", "Tap Subscribe", "Screenshot", "Submit proof"], "Do not unsubscribe after proof."),
    S("yt_views", "view", "YouTube Views", "Real views on your YouTube video", 0.003, 0.0021, 0.0009, "views", 500, 100000, [500, 1000, 5000, 10000], "~48h", "https://www.youtube.com/watch?v=…", ["Watch this YouTube video"], ["Open the video", "Watch the required time", "Screenshot", "Submit proof"], "Watch genuinely."),
    ...
    S("yt_comments", "comment", "YouTube Comments", "Real comments on your YouTube video", 0.03, 0.021, 0.009, "comments", 20, 5000, [20, 50, 100, 250], "~72h", "https://www.youtube.com/watch?v=…", ["Comment on this YouTube video"], ["Open the video", "Post a relevant comment", "Screenshot", "Submit proof"], "Spam comments will be rejected."),
    S("yt_watch", "watch", "YouTube Watch & Earn", "Verified watch-seconds on your YouTube video", 0.0001, 0.00007, 0.00003, "seconds", 1, 3600, [30, 60, 120, 300, 600], "~24h", "https://www.youtube.com/watch?v=…", ["Watch this YouTube video for the required time"], ["Open the video", "Watch for the required duration", "Do not skip", "Submit proof"], "Verified watch activity required."),
  ],
  tiktok: [
    ...
    S("tt_views", "view", "TikTok Views", "Real views on your TikTok video", 0.002, 0.0014, 0.0006, "views", 500, 100000, [500, 1000, 5000, 10000], "~24h", "https://www.tiktok.com/@user/video/…", ["Watch this TikTok video"], ["Open the video", "Watch fully", "Screenshot", "Submit proof"], "Watch before submitting."),
    S("tt_comments", "comment", "TikTok Comments", "Real comments on your TikTok video", 0.025, 0.0175, 0.0075, "comments", 20, 5000, [20, 50, 100, 250], "~48h", "https://www.tiktok.com/@user/video/…", ["Comment on this TikTok video"], ["Open the video", "Leave a relevant comment", "Screenshot", "Submit proof"], "Relevant comments only."),
  ],
  x: [
    ...
    S("x_comments", "comment", "X Comments", "Real comments on your X post", 0.025, 0.0175, 0.0075, "comments", 20, 5000, [20, 50, 100, 250], "~48h", "https://x.com/user/status/…", ["Reply to this post on X"], ["Open the post", "Reply with a relevant comment", "Screenshot", "Submit proof"], "Spam replies will be rejected."),
  ],
  facebook: [
    ...
    S("fb_comments", "comment", "Facebook Comments", "Real comments on your Facebook post", 0.025, 0.0175, 0.0075, "comments", 20, 5000, [20, 50, 100, 250], "~48h", "https://www.facebook.com/…/posts/…", ["Comment on this Facebook post"], ["Open the post", "Leave a relevant comment", "Screenshot", "Submit proof"], "Relevant comments only."),
  ],
  linkedin: [
    ...
    S("li_comments", "comment", "LinkedIn Comments", "Real comments on your LinkedIn post", 0.03, 0.021, 0.009, "comments", 20, 2000, [20, 50, 100], "~72h", "https://www.linkedin.com/posts/…", ["Comment on this LinkedIn post"], ["Open the post", "Write a professional comment", "Screenshot", "Submit proof"], "Professional comments only."),
  ],
  threads: [
  ...
  discord: [
    ...
    S("dc_engage", "join", "Discord Engagement", "Active engagement in your server", 0.025, 0.0175, 0.0075, "actions", 20, 5000, [20, 50, 100, 250], "~48h", "https://discord.gg/…", ["Engage in this Discord server"], ["Join the server", "Send a relevant message", "Screenshot", "Submit proof"], "Spam messages will be rejected."),
  ],
  spotify: [
    S("sp_plays", "view", "Spotify Plays", "Real plays on your Spotify track", 0.002, 0.0014, 0.0006, "plays", 500, 100000, [500, 1000, 5000], "~48h", "https://open.spotify.com/track/…", ["Play this Spotify track"], ["Open the track on Spotify", "Play fully", "Screenshot", "Submit proof"], "Spotify only."),
  ...
  soundcloud: [
    S("sc_plays", "view", "SoundCloud Plays", "Real plays on your SoundCloud track", 0.002, 0.0014, 0.0006, "plays", 500, 100000, [500, 1000, 5000], "~48h", "https://soundcloud.com/…", ["Play this SoundCloud track"], ["Open the track", "Play fully", "Screenshot", "Submit proof"], "SoundCloud only."),
  ...
  audiomack: [
    S("am_plays", "view", "Audiomack Plays", "Real plays on Audiomack", 0.0015, 0.00105, 0.00045, "plays", 500, 100000, [500, 1000, 5000], "~48h", "https://audiomack.com/…", ["Play this Audiomack track"], ["Open the track", "Play fully", "Screenshot", "Submit proof"], "Audiomack only."),
  ...
  app_review: [
    S("ar_ios", "review", "iOS App Reviews", "Real reviews on the App Store", 1.5, 1.05, 0.45, "reviews", 10, 500, [10, 25, 50, 100], "~96h", "https://apps.apple.com/app/…", ["Review this iOS app"], ["Open the App Store page", "Leave an honest review", "Screenshot", "Submit proof"], "Honest reviews only."),
    S("ar_android", "review", "Android App Reviews", "Real reviews on Google Play", 1.5, 1.05, 0.45, "reviews", 10, 500, [10, 25, 50, 100], "~96h", "https://play.google.com/store/apps/…", ["Review this Android app"], ["Open Play Store", "Leave an honest review", "Screenshot", "Submit proof"], "Honest reviews only."),
    S("ar_ratings", "review", "App Ratings", "Star ratings for your mobile app", 0.5, 0.35, 0.15, "ratings", 20, 1000, [20, 50, 100, 250], "~72h", "App Store or Play Store URL", ["Rate this app"], ["Open the store page", "Submit a rating", "Screenshot", "Submit proof"], "Genuine ratings only."),
  ],
  google: [
    S("gb_reviews", "review", "Google Business Reviews", "Real Google Business reviews", 0.25, 0.175, 0.075, "reviews", 10, 200, [10, 25, 50], "~96h", "https://maps.google.com/…", ["Review this Google Business"], ["Open the listing", "Leave an honest review", "Screenshot", "Submit proof"], "Honest local reviews only."),
    S("gb_seo", "view", "Local SEO Boost", "Visibility boost for your Google listing", 1.5, 1.05, 0.45, "package", 1, 1, [1], "~7d", "Google Business URL", ["Boost this Google listing"], ["Open the listing", "Engage as instructed", "Screenshot", "Submit proof"], "Follow instructions carefully."),
  ],
  website: [
    S("web_traffic", "view", "Website Traffic", "Real visitors to your website", 0.003, 0.0021, 0.0009, "visits", 500, 100000, [500, 1000, 5000], "~48h", "https://yoursite.com", ["Visit this website"], ["Open the URL", "Browse for 30+ seconds", "Screenshot", "Submit proof"], "Stay on page for the required time."),
    S("web_signups", "join", "Website Sign-ups", "Real user registrations", 0.04, 0.028, 0.012, "sign-ups", 20, 5000, [20, 50, 100, 250], "~72h", "https://yoursite.com/signup", ["Sign up on this website"], ["Open the signup page", "Create an account", "Screenshot confirmation", "Submit proof"], "Real emails only."),
  ...
  survey: [
    S("sv_responses", "join", "Survey Responses", "Real survey completions", 0.5, 0.35, 0.15, "responses", 20, 5000, [20, 50, 100, 250], "~72h", "https://forms.google.com/…", ["Complete this survey"], ["Open the survey", "Answer honestly", "Screenshot completion", "Submit proof"], "Honest answers only."),
    S("sv_votes", "like", "Poll Votes", "Real votes on your online poll", 0.25, 0.175, 0.075, "votes", 20, 50000, [20, 50, 100, 250, 500], "~24h", "Poll / contest URL", ["Vote on this poll"], ["Open the poll", "Cast your vote", "Screenshot", "Submit proof"], "One vote per person unless stated."),
  ],
  pinterest: [
  ...
  twitch: [
    ...
    S("tw_views", "view", "Twitch Views", "Real views on Twitch stream/VOD", 0.003, 0.0021, 0.0009, "views", 500, 50000, [500, 1000, 5000], "~48h", "https://www.twitch.tv/videos/…", ["Watch this Twitch VOD"], ["Open the stream or VOD", "Watch for required time", "Screenshot", "Submit proof"], "Watch genuinely."),
    S("tw_chat", "comment", "Twitch Chat Engagement", "Active chat during your stream", 0.025, 0.0175, 0.0075, "messages", 20, 5000, [20, 50, 100, 250], "~24h", "https://www.twitch.tv/yourname", ["Chat on this Twitch stream"], ["Join the live stream", "Send a relevant chat message", "Screenshot", "Submit proof"], "Spam chat will be rejected."),
  ],
};
