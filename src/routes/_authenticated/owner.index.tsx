...
const QUICK = [
  ...
  { to: "/owner/deposits", title: "Deposits", desc: "Confirm funds", Icon: ArrowDownCircle },
  { to: "/owner/users", title: "Users", desc: "Search · deduct", Icon: Users },
  ...
  { to: "/owner/monetization", title: "Monetization", desc: "Providers · APIs", Icon: SlidersHorizontal },
  { to: "/owner/payment-settings", title: "Payments", desc: "Crypto gateways", Icon: CreditCard },
  { to: "/owner/economy", title: "Economy", desc: "Fees · min $", Icon: Coins },
  { to: "/owner/settings", title: "Telegram Gate", desc: "Join requirements", Icon: Lock },
] as const;
...
function OwnerHub() {
  ...
  const stats = basic
    ? [
        ...
        { label: "Active 7d", value: String(basic.activeUsers ?? "—") },
      ...
      <div className="px-4 pt-4">
        ...
        >
          ...
          <p className="mt-1 text-[11px] text-slate-400">
            Full navigation in the menu (☰). Users, Money, Monetization, Gate, System.
          </p>
        </div>
        ...
        <p className="mt-6 text-center text-[11px] text-slate-500">
          Pages load faster — gate membership is cached (no 15s API spam).
        </p>
      </div>
    </OwnerShell>
  );
